        ...
        [
            (
                ...
                (
                    ...
                    "- Prefer worker='codex' for structured analysis, review, diagnosis, explanation, or planning.\n"
                    "- Prefer worker='opencode' for concrete implementation, editing, file generation, or patching.\n"
                    "- Use session_mode='resume' with worker='codex' when the task is clearly continuing earlier work in this same PC session.\n"
                    ...
                    "- If the user interrupts the current delegated task, stop the old direction cleanly and continue from the new instruction instead of pretending no interruption happened.\n"
