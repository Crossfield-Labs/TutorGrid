...
这份文档用于说明当前重构完成后的下一阶段重点工作，以及为什么优先级要调整为 **GUI 优先**。
...
在 GUI 时代，LangChain 最值得继续扩展的方向是：
1. 压缩链
2. 摘要链
3. 错误解释链
4. 历史会话恢复时的上下文重建链
